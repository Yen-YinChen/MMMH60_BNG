...
<!-- lightbox (added by CM)-->
<link rel="stylesheet" href="./css/BNG_homepage_lightbox_cm.css">
<!-- 以上為lightbox -->
</head>
                ...
                <div class="hpViewMoreButtonWrapVv d-flex justify-content-center align-items-center">
                    <a href="#">
                        <div class="hpViewMoreButtonVv d-flex justify-content-center align-items-baseline">
                            <div class="hpViewMoreVv" onclick="goToTour();">VIEW MORE</div>
...
// 在最外層的div test-wrapvv跑for迴圈，上下各8筆，總共16筆資料
                    ...
                    <div class="hpViewMoreButtonWrapVv d-flex justify-content-center align-items-center">
                        <a href="#">
                            <div class="hpViewMoreButtonVv d-flex justify-content-center align-items-baseline">
                                <div class="hpViewMoreVv" onclick="goToSocial();">VIEW MORE</div>
                                <div class="arrowWrapVv"><img src="./img/arrowThin.svg" alt=""></div>
                            </div>
                        </a>
                    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>考量國內疫情嚴峻及維護消費者之安全與權利，本公司「Bike N Go」即日起至6月28日止，取消所有自行車旅遊行程。
                    6月28日以後之行程，將視疫情發展狀況，配合中央流行疫情指揮中心政策滾動式調整因應，並以旅客最大權益為優先考量。
                </p>
            </div>
        </div>
    </div>
...
<script>
    ...
    //view more link to productList:
    function goToTour(){
        window.location = "<?php echo WEB_ROOT;?>/productList.php";
    }
    //view more link to page1_YK:
    function goToSocial(){

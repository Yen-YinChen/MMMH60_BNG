...
<link rel="stylesheet" href="./css/BNG-billingpage_cm.css">
...
<div class="ContentCm d-none d-sm-block">
    <section class="billing-sectionbg-cm d-none d-sm-block">
                ...
                <div class="content">
                    ...
                    <div class="row billingpage-row-cm">
                        <div class="col-3 billingpage-imgsize-cm">
                            <img src="./img/tours/T05E204.jpg" alt="" class="billingpage-img-cm">
                        </div>
                        <div class="col-6 billingpage-item-cm">

                            <p class="billingpage-title-cm">七星潭濱海自行車道</p>

                            <div class="row billingpage-daterow-cm">
                                <img src="./img/calender-icon.svg" alt="" class="billingpage-calender-cm">
                                <p class="billingpage-detail-cm"> 2021-07-15 至 2021-07-16</p>
                            </div>


                            <p class="billingpage-detail-cm">人數 x 1</p>
                            <p class="billingpage-detail-cm">金額 TWD 3,000</p>
                        </div>
        ...
        <div class="container billingpage-card-cm">
            <div class="box billingpage-box-cm">
                <div class="row billingpage-row1style-cm">
                    ...
                    <div class="item">
                        <h4 class="billingpage-title-cm">七星潭濱海自行車道</h4>
                        <p class="billingpage-date1-cm">2021-07-15 <span class="billingpage-pl1-cm">人數 x 1</span>
                        </p>
                    </div>
                </div>
        ...
        <div class="container billingpage-card-cm">
            <form class="box billingpage-box-cm needs-validation" method="post" id="billingpageSubmit" novalidate>
                <div class="row">
                    <div class="item">
                ...
                <div class="content" id="content3">
                    ...
                    <div class="row billingpage-btnr-cm">
                        <div class="item billingpage-lastbtn-cm">
                            <input type="button" class="btn btn-primary bp-lastbtn-cm" onclick="myOrders()" value="確認付款"></input>
                        </div>
...
<section class="d-block d-sm-none billingpage-sectionbg-mb-cm">
    ...
    <div class="container billingpage-card4-mb-cm">
        ...
        <div class="content" id="content3_mb">
            ...
            <form class="needs-validation" id="formMobileSubmit" novalidate>
                ...
                <input type="text" class="form-control form-control-sm form-control-cm" id="" placeholder="MM / YY">
                ...
                <div class="row">
                    ...
                    <button type="button" onclick="myOrders()" class="btn btn-primary btn-primary-cm">確認付款</button>
                </div>
...
<script src="./js/BNG-billingpage_cm.js"></script>
<script>
    function myOrders() {
        window.location = "<?php echo WEB_ROOT; ?>/BNG-paidpage_cm.php";
    }

    // let deskInput = document.getElementById('billingpageSubmit');
    // deskInput.addEventListener('submit', function(event) {
    //     window.location = "<?php echo WEB_ROOT; ?>/BNG-paidpage_cm.php";
    // })

    let mobileInput = document.getElementById('formMobileSubmit');
    mobileInput.addEventListener('submit', function(event) {
        window.location = "<?php echo WEB_ROOT; ?>/BNG-paidpage_cm.php";
    })
</script>

...
<?php include __DIR__. '/parts/BNG_head_Vv.php'; ?>
    ...
    <link rel="stylesheet" href="<?php echo WEB_ROOT;?>/css/member_inbox-ycn.css">
<title>member_inbox</title>
    </head>
        ...
        <div class="container member-wrapper ycn">
            ...
            <div class="row member-menu-page-icon-div-ycn">
                <div class="menu-page-icon">
                    ...
                    <img id="memberPageIconBG" src="<?php echo WEB_ROOT; ?>/img/member_pageIconBg.png" alt="">
                </div>
            </div>
            <!--------- menu icons ----------->
            ...
            <!-- ------inbox by YCN----------- -->
            <div class="container inbox-div-ycn">
                <div class="inbox-header-div-ycn">
                    <div class="inbox-header-text-div ycn">
                        <div class="inbox-header-text ycn" id="inbox-header-sender ycn">
                            <p>寄件人</p>
                        </div>
                        <div class="inbox-header-text ycn" id="inbox-head-title">
                            <p>主旨</p>
                        </div>
                        <div class="inbox-header-text ycn" id="inbox-header-text-date-trash">
                            <span>日期</span>
                            <div id="inbox-header-trashAll-div">
                                <svg id="inbox-head-trashAll-svg" xmlns="http://www.w3.org/2000/svg"
                                     viewBox="0 0 23.125 28.462">
                                    <g id="trash" transform="translate(-48)">
                                        <path id="Path_640" data-name="Path 640"
                                              d="M69.346,5.337H66.678V1.779A1.779,1.779,0,0,0,64.9,0H54.226a1.779,1.779,0,0,0-1.779,1.779V5.337H49.779A1.779,1.779,0,0,0,48,7.115V8.894H71.125V7.115A1.779,1.779,0,0,0,69.346,5.337ZM56,5.337V3.558H63.12V5.337Z"
                                              transform="translate(0 0)" fill="#d8d8d9" />
                                        <path id="Path_641" data-name="Path 641"
                                              d="M80,208.01a1.779,1.779,0,0,0,1.779,1.779h16.01a1.778,1.778,0,0,0,1.778-1.778h0V192H80Zm13.341-11.563a.889.889,0,1,1,1.779,0v8.894a.889.889,0,0,1-1.779,0Zm-4.447,0a.889.889,0,1,1,1.779,0v8.894a.889.889,0,0,1-1.779,0Zm-4.447,0a.889.889,0,1,1,1.779,0v8.894a.889.889,0,0,1-1.779,0Z"
                                              transform="translate(-30.221 -181.327)" fill="#d8d8d9" />
                                    </g>
                                </svg>
                            </div>
                        </div>
                ...
                <ul class="list-group ycn">
                    <li class="list-group-item odd-list-item ycn">
                        <div class="listHead ycn">
                            <svg class="star" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 21.84 21">
                                <path id="Polygon_8" data-name="Polygon 8"
                                      d="M10.92,0,13.5,8.021H21.84l-6.749,4.957L17.669,21,10.92,16.043,4.171,21l2.578-8.021L0,8.021H8.342Z" />
                            </svg>
                            <span>BikeNGo</span>
                        </div>
                        <span>您已訂購七星潭...</span>
                        <div class="listTail ycn">
                            <span>2021-06-18</span>
                            <div class="inbox-content-trash-div">
                                <svg class="inbox-content-trash-svg" xmlns="http://www.w3.org/2000/svg"
                                     viewBox="0 0 23.125 28.462">
                                    <g id="trash" transform="translate(-48)">
                                        <path id="Path_640" data-name="Path 640"
                                              d="M69.346,5.337H66.678V1.779A1.779,1.779,0,0,0,64.9,0H54.226a1.779,1.779,0,0,0-1.779,1.779V5.337H49.779A1.779,1.779,0,0,0,48,7.115V8.894H71.125V7.115A1.779,1.779,0,0,0,69.346,5.337ZM56,5.337V3.558H63.12V5.337Z"
                    ...
                    <li class="list-group-item even-list-item ycn">
                        <div class="listHead ycn">
                            <svg class="star" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 21.84 21">
                                <path id="Polygon_8" data-name="Polygon 8"
                                      d="M10.92,0,13.5,8.021H21.84l-6.749,4.957L17.669,21,10.92,16.043,4.171,21l2.578-8.021L0,8.021H8.342Z" />
                ...
                <div class="write-email-div ycn">
                    <button type="" onclick="writeEmail();" id="write-email-ycn" class="btn btn-primary">
                        <span>寫信</span>
                    </button>
                </div>
            </div>
...
<?php include __DIR__. '/parts/BNG_scripts_Vv.php'; ?>
    <script>
        ...
        //Setting up menuPage icon and RWDs:
        if (window.innerWidth >576){
            //forcing elements menuPageIcon style (desktop version)
            //---menu-page icon ----
            let menuPageIcon = document.getElementsByClassName('menu-page-icon')[0];
            menuPageIcon.style['position'] = 'relative';
            menuPageIcon.style['background-image'] = 'none';
            menuPageIcon.style['padding-top'] = '0px';
            menuPageIcon.style['text-align'] = 'center';


            let memberPageIconText = document.getElementById('member-page-icon-text');
            memberPageIconText.style['position'] = 'absolute';
            memberPageIconText.style['left'] = '3rem';
            memberPageIconText.style['top'] = '0.9rem';
            memberPageIconText.style['display'] = 'block';

            let memberPageIconBG = document.getElementById('memberPageIconBG');
            memberPageIconBG.style['width'] = '100%';
            memberPageIconBG.style['height'] = '100%';
        } else {
            //forcing elements menuPageIcon style (mobile version)
            //---menu-page icon ----
            let menuPageIcon = document.getElementsByClassName('menu-page-icon')[0];
            menuPageIcon.style['position'] = 'relative';
            menuPageIcon.style['background-image'] = 'none';
            ...
            let memberPageIconText = document.getElementById('member-page-icon-text');
            memberPageIconText.style['position'] = 'absolute';
            memberPageIconText.style['left'] = '1.68rem';
            memberPageIconText.style['top'] = '0.5rem';
            memberPageIconText.style['display'] = 'block';
        ...
        //button: Link to write mail page
        function writeEmail(){
            window.location ="<?php echo WEB_ROOT;?>/member_writeEmail_YCN.php";
        }

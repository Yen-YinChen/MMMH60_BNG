...
<!--<link rel="stylesheet" href="./css/member_readEmail.css">-->
    <link rel="stylesheet" href="./css/member_Profile-ycn.css">
<link rel="stylesheet" href="./css/BNG-myorders_cm.css">
</head>
...
<div class="container-fluid member-contain ycn">
    <div class="container member-wrapper ycn">
        ...
        <div class="row member-menu-div-ycn">
            ...
            <div class="menu-icon-div mem-ico-friendlist-ycn">
                <a class="menu-icon-a ycn" href="<?php echo WEB_ROOT;?>/member_friendList_YCN.php" onclick="menuClick(event);">
                    ...
                    <div class="menu-icon-svg-div-clicked">
                        <svg class="menu-icon-svg-clicked ycn" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 95 95">
                            <g id="Group_544" data-name="Group 544" transform="translate(-0.128 -0.154)">
            ...
            <div class="menu-icon-div mem-ico-inbox-ycn">
                <a class="menu-icon-a ycn" href="<?php echo WEB_ROOT;?>/member_inbox_YCN.php" onclick="menuClick(event);">
                    <div class="menu-icon-svg-div-unclicked">
                        <svg class="menu-icon-svg ycn" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 96 95">
                            <defs>
                            ...
                            <g id="Group_543" data-name="Group 543" transform="translate(-0.239 -0.154)">
                                ...
                                <g id="Group_539" data-name="Group 539" transform="translate(19.797 26.762)">
                                    ...
                                    <g id="Mask_Group_65" data-name="Mask Group 65" transform="translate(0 0)" clip-path="url(#clip-path-inbox)">
                    ...
                    <div class="menu-icon-svg-div-clicked">
                        <svg class="menu-icon-svg-clicked ycn" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 96 95">
                            <defs>
                            ...
                            <g id="Group_587" data-name="Group 587" transform="translate(-0.238 -0.154)">
                                ...
                                <g id="Group_539" data-name="Group 539" transform="translate(19.797 26.762)">
                                    ...
                                    <g id="Mask_Group_65" data-name="Mask Group 65" transform="translate(0 0)" clip-path="url(#clip-path-inbox-clicked)">
            ...
            <div class="menu-icon-div mem-ico-shopHisto-ycn">
                <a class="menu-icon-a ycn active" href="<?php echo WEB_ROOT;?>/BNG-myorders_cm.php" onclick="menuClick(event);">
                    <div class="menu-icon-svg-div-unclicked">
                        <svg class="menu-icon-svg ycn" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 95 95">
                    ...
                    <div class="menu-icon-svg-div-clicked">
                        <svg class="menu-icon-svg-clicked" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 95 95">
                            <g id="Group_SPP" data-name="Group SPP" transform="translate(-0.487 -0.154)">
                                <g id="Ellipse_SPP" data-name="Ellipse SPP" transform="translate(0.487 0.154)" fill="#ff7300" stroke="#ff7300" stroke-width="1">
                                    <circle cx="47.5" cy="47.5" r="47.5" stroke="none" />
                                    <circle cx="47.5" cy="47.5" r="47" fill="none" />
                                </g>
                                <g id="shopping-list" transform="translate(18.487 16.798)">
        ...
        <!-- Computer My Order Content -->
        <div class="content" id="content">
            <div class="container myorderspage-card1-cm d-none d-sm-block">
                <div class="box myorderspage-box-cm">
                    <div class="row">
                        <div class="col">
                            <div class="item myorderspage-imgitem-cm">

                            </div>
                        </div>

                        <div class="col-6 myorderspage-cl-cm">
                            <p class="myorderspage-title-cm">七星潭濱海自行車道 <br>「運動級」</p>
                            <p class="myorderspage-detail-cm">去程 : 2021-07-15<span><span class="myorderspage-whiteword-cm">123</span> 回程 : 2021-07-16</span>
                            </p>
                            <p class="myorderspage-people-cm">人數 x 1</p>
                            <p class="myorderspage-amount-cm">總金額 TWD 2,550</p>
                        </div>

                        <div class="myorderspage-linedash-cm"></div>
                    </div>
            ...
            <div class="container myorderspage-card1-cm d-none d-sm-block">
                <div class="box myorderspage-box-cm">
                    <div class="row">
                        <div class="col">
                            <div class="item myorderspage-imgitem2-cm">

                            </div>
                        </div>

                        <div class="col-6 myorderspage-cl-cm">
                            <p class="myorderspage-title-cm">壯圍舊草嶺單車二日 <br>「輕鬆級」</p>
                            <p class="myorderspage-detail-cm">去程 : 2021-05-01<span><span class="myorderspage-whiteword-cm">123</span> 回程 : 2021-05-02</span>
                            </p>
                            <p class="myorderspage-people-cm">人數 x 1</p>
                            <p class="myorderspage-amount-cm">總金額 TWD 1,888</p>
                        </div>
        ...
        <!-- Mobile My Order Content -->
        <div class="container myorderspage-card1-mb-cm d-block d-sm-none">
            <div class="row myorderspage-row-mb-cm">
                <div class="col-7">
                    <p class="myorderspage-title-mb-cm">七星潭濱海自行車道「運動級」</p>
                    <p class="myorderspage-detail-mb-cm">去程 : 2021-07-15 <br> 回程 : 2021-07-16</p>
                    <p class="myorderspage-myorderno-mb-cm">訂單編號 :T05E20715</p>
                </div>
            </div>
        </div>
        ...
        <div class="container myorderspage-card1-mb-cm d-block d-sm-none">
            <div class="row myorderspage-row-mb-cm">
                <div class="col-7">
                    <p class="myorderspage-title-mb-cm">壯圍舊草嶺單車二日「輕鬆級」</p>
                    <p class="myorderspage-detail-mb-cm">去程 : 2021-05-01 <br> 回程 : 2021-05-02</p>
                    <p class="myorderspage-myorderno-mb-cm">訂單編號 :T62N10501</p>
                </div>
            </div>
        </div>
...
<script src="./js/BNG-myorders_cm.js"></script>
<script>
    /* Bug fix by YCN -- correcting the mobile version content height---*/
    if (window.innerWidth <= 576){
        $('.member-contain').css('height', 'calc(100vh - 68px)');
    }
</script>

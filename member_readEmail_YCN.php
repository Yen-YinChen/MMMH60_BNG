...
<?php include __DIR__. '/parts/BNG_head_Vv.php'; ?>
   ...
   <link rel="stylesheet" href="<?php echo WEB_ROOT;?>/css/member_readEmail-ycn.css">
    <title>member_readEmail</title>
    </head>
<?php include __DIR__. '/parts/BNG_navbar_topButton_Vv.php'; ?>

    <!-- ---read EMAIL PAGE BY YCN ----- -->
    <div class="container-fluid member-contain ycn">
        <div class="container member-wrapper ycn">
            ...
            <!-- -------read email-------- -->
            <div class="container readEmail-div-ycn">
                <div class="readEmail-header-div-ycn">
                    <div class="readEmail-header-text ycn" id="readEmail-header-sender ycn">
                        <p>閱讀郵件</p>
                    </div>
                </div>
                <form class="readEmail ycn">
                    <div class="readEmail-recipient-div form-group ycn">
                    ...
                    <div class="readEmail-title-div form-group ycn">
                        <label class="form-list-head-label" for="titleInput">
                            <p class="form-list-head ycn">主旨</p>
                        </label>
                        <input type="text" class="form-control" id="titleInput">
                    </div>
                    <div class="readEmail-content-div form-group ycn">
                        <label for="readEmail-content-input"></label>
                        <textarea class="readEmail-content-input form-control" id="readEmail-content-input"
                                  rows="8"></textarea>
                    </div>
                    <div class="read-email-buttom-div ycn">
                        <button type="submit" id="read-email-ycn" class="btn btn-primary">
                            <span>回覆</span>
                        </button>
                    </div>
                </form>
...
<?php include __DIR__. '/parts/BNG_scripts_Vv.php'; ?>
    <script>
        ...
        if ($(window).width() >= 577) {
            ...
            // ---readEmail: Set textarea rows to 20-----------
            let emailContentRows = document.getElementById('readEmail-content-input');
